...
export async function writePendingJob(storage: StorageClient<RoleId>, job: MemoryExtractionJob): Promise<string> {
...
export async function drainPendingJobsOnStartup(storage: StorageClient<RoleId>): Promise<void> {
