...
class MagnitudeAgent(BaseInstalledAgent):
    ...
    async def _try_install_from_volume(self, environment: BaseEnvironment) -> bool:
        """Try to install magnitude from a mounted volume."""
        current_path = "/magnitude-binaries/magnitude/current"
        ...
        try:
            ...
            volume_binary = f"/magnitude-binaries/magnitude/sha256/{binary_hash}/magnitude"
    ...
    def populate_context_post_run(self, context: AgentContext) -> None:
        ...
        Reads the ATIF trajectory generated by --atif /logs/agent/trajectory.json
        and populates Harbor context fields (cost, tokens) from final_metrics.
        """
